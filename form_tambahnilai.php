...
<body>
	<div class="easyui-panel" title="Input Nilai" style="width:400px">
	    ...
	    <form id="ff" method="post" action="aksi.php?act=tambahnilai">
	    	<table cellpadding="5">
	    		<tr>
	    			<td>Nilai:</td>
	...
	?>	    		
	    ...
	    <div style="text-align:center;padding:5px">
            ...
            <a href="home.php?menu=nilai" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-cancel'">Cancel</a>
	    </div>
	    </div>
	</div>
	<script>
